...
def plot(args):
    ...
    if plot_avg:
        save_fig_path = env_name + "_avg.png"
    else:
        save_fig_path = env_name + ".png"

    all_files = glob.glob(log_dir + f'/dt_{env_name}*.csv')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--env_name', type=str, default='task1')
    parser.add_argument('--log_dir', type=str, default='dt_runs/')
    parser.add_argument('--x_key', type=str, default='num_updates')
    parser.add_argument('--y_key', type=str, default='eval_score')
